            ...
            <div className='featured-bg-image text-white p-16'>
              ...
              <aside className='grid md:grid-cols-2 grid-cols-1 gap-5 md:gap-10 md:mx-36 items-center'>
                ...
                <div>
                    ...
                    <p className='md:text-sm text-[12px]'>We ate the buffet and that included almost 40 items in total. I remember eating around 8-9 items while my parents ate far less that that. But my younger brother John enjoyed more than 20 items. Side note: He did not eat all the items. He just tasted many of them!</p>
